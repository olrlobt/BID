...
import { stuChangePwdApi, getMyBidListApi, getMyAvatarListApi,editAvatarApi ,updateUsersApi} from '../../Apis/ModelApis';
...
/** 비밀번호 변경 handler */
  ...
  const changeAvatar = (clickedAvatarNo) => {
    const targetAvatar = myAvatarInfo.find((avatarInfo) => avatarInfo.avatarNo === clickedAvatarNo);
    if (targetAvatar) {
      let avatarNo = {
        ...
        <div className={styled.leftArea}>
          <div className={styled.userInfoArea}>
            ...
            <div className={styled.descArea}>
              ...
              {myInfo.schoolName} {myInfo.IdInfo.grade}학년 {myInfo.IdInfo.class}반 {myInfo.IdInfo.number}번
              </div>
