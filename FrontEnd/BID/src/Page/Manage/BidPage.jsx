  ...
  const dummyProducts = [
    {
      ...
      goodsImgUrl:
        "https://sitem.ssgcdn.com/64/46/21/item/1000524214664_i1_750.jpg",
      category: "기타",
      userName: "백지윤",
      startPrice: 360,
      averagePrice: 480,
      ...
      comments: [
        {
          ...
          name: "유현지",
          content:
            "우효~ 귀여워라 우효~ 귀여워라 우효~ 귀여워라 우효~ 귀여워라 우효~ 귀여워라 우효~ 귀여워라 우효~ 귀여워라 우효~ 귀여워라 우효~ 귀여워라 우효~ 귀여워라 우효~ 귀여워라 우효~ 귀여워라 우효~ 귀여워라 ",
    ...
    },
    {
      ...
      title: "주판",
      description:
        "주판 학원 다닐 때 쓰던 건데 이젠 사용하지 않아서 경매에 올립니다! 연락 많이 주세용",
      goodsImgUrl:
